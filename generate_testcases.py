...
def main(challenge_id=-1):
    ...
    if int(challenge_id) == 3539:
        from source import Generator3539
        tests = Generator3539.generate()

    if int(challenge_id) == 2273:
        from source import Generator2273
        tests = Generator2273.generate()

    if int(challenge_id) == 3349:
        from source import Generator3349
        tests = Generator3349.generate()

    if int(challenge_id) == 3350:
        from source import Generator3350
        tests = Generator3350.generate()

    if int(challenge_id) == 2598:
        from source import Generator2598
        tests = Generator2598.generate()

    if int(challenge_id) == 3003:
        from source import Generator3003
        tests = Generator3003.generate()

    if int(challenge_id) == 3397:
        from source import Generator3397
        tests = Generator3397.generate()

    if int(challenge_id) == 1625:
        from source import Generator1625
        tests = Generator1625.generate()

    if int(challenge_id) == 2011:
        from source import Generator2011
        tests = Generator2011.generate()

    if int(challenge_id) == 3346:
        from source import Generator3346
        tests = Generator3346.generate()

    if int(challenge_id) == 3347:
        from source import Generator3347
        tests = Generator3347.generate()

    if int(challenge_id) == 3461:
        from source import Generator3461
        tests = Generator3461.generate()

    if int(challenge_id) == 2048:
        from source import Generator2048
        tests = Generator2048.generate()

    if int(challenge_id) == 1716:
        from source import Generator1716
        tests = Generator1716.generate()

    if int(challenge_id) == 2043:
        from source import Generator2043
        tests = Generator2043.generate()

    if int(challenge_id) == 2125:
        from source import Generator2125
        tests = Generator2125.generate()

    if int(challenge_id) == 3354:
        from source import Generator3354
        tests = Generator3354.generate()

    if int(challenge_id) == 3370:
        from source import Generator3370
        tests = Generator3370.generate()

    if int(challenge_id) == 1526:
        from source import Generator1526
        tests = Generator1526.generate()

    if int(challenge_id) == 3289:
        from source import Generator3289
        tests = Generator3289.generate()
    ...
    if int(challenge_id) == 3318:
        from source import Generator3318
        tests = Generator3318.generate()

    if int(challenge_id) == 3321:
        from source import Generator3321
        tests = Generator3321.generate()

    if int(challenge_id) == 3607:
        from source import Generator3607
        tests = Generator3607.generate()

    if int(challenge_id) == 2528:
        from source import Generator2528
        tests = Generator2528.generate()

    if int(challenge_id) == 1611:
        from source import Generator1611
        tests = Generator1611.generate()

    if int(challenge_id) == 2169:
        from source import Generator2169
        tests = Generator2169.generate()

    if int(challenge_id) == 3542:
        from source import Generator3542
        tests = Generator3542.generate()

    if int(challenge_id) == 474:
        from source import Generator474
        tests = Generator474.generate()

    if int(challenge_id) == 2654:
        from source import Generator2654
        tests = Generator2654.generate()

    if int(challenge_id) == 3228:
        from source import Generator3228
        tests = Generator3228.generate()

    if int(challenge_id) == 2536:
        from source import Generator2536
        tests = Generator2536.generate()

    if int(challenge_id) == 3234:
        from source import Generator3234
        tests = Generator3234.generate()

    if int(challenge_id) == 1513:
        from source import Generator1513
        tests = Generator1513.generate()

    if int(challenge_id) == 1437:
        from source import Generator1437
        tests = Generator1437.generate()

    if int(challenge_id) == 717:
        from source import Generator717
        tests = Generator717.generate()

    if int(challenge_id) == 2154:
        from source import Generator2154
        tests = Generator2154.generate()

    if int(challenge_id) == 757:
        from source import Generator757
        tests = Generator757.generate()

    if int(challenge_id) == 1930:
        from source import Generator1930
        tests = Generator1930.generate()

    if int(challenge_id) == 3190:
        from source import Generator3190
        tests = Generator3190.generate()

    if int(challenge_id) == 1262:
        from source import Generator1262
        tests = Generator1262.generate()

    if int(challenge_id) == 1018:
        from source import Generator1018
        tests = Generator1018.generate()

    if int(challenge_id) == 1015:
        from source import Generator1015
        tests = Generator1015.generate()

    if int(challenge_id) == 2435:
        from source import Generator2435
        tests = Generator2435.generate()

    if int(challenge_id) == 3381:
        from source import Generator3381
        tests = Generator3381.generate()

    if int(challenge_id) == 2872:
        from source import Generator2872
        tests = Generator2872.generate()

    if int(challenge_id) == 3512:
        from source import Generator3512
        tests = Generator3512.generate()

    if int(challenge_id) == 1590:
        from source import Generator1590
        tests = Generator1590.generate()

    if int(challenge_id) == 2141:
        from source import Generator2141
        tests = Generator2141.generate()

    if int(challenge_id) == 3623:
        from source import Generator3623
        tests = Generator3623.generate()

    if int(challenge_id) == 3625:
        from source import Generator3625
        tests = Generator3625.generate()

    if int(challenge_id) == 2211:
        from source import Generator2211
        tests = Generator2211.generate()

    if int(challenge_id) == 3432:
        from source import Generator3432
        tests = Generator3432.generate()

    if int(challenge_id) == 3578:
        from source import Generator3578
        tests = Generator3578.generate()

    if int(challenge_id) == 1523:
        from source import Generator1523
        tests = Generator1523.generate()

    if int(challenge_id) == 1925:
        from source import Generator1925
        tests = Generator1925.generate()

    if int(challenge_id) == 3583:
        from source import Generator3583
        tests = Generator3583.generate()

    if int(challenge_id) == 3577:
        from source import Generator3577
        tests = Generator3577.generate()

    if int(challenge_id) == 3531:
        from source import Generator3531
        tests = Generator3531.generate()

    if int(challenge_id) == 3433:
        from source import Generator3433
        tests = Generator3433.generate()

    if int(challenge_id) == 3606:
        from source import Generator3606
        tests = Generator3606.generate()

    if int(challenge_id) == 2147:
        from source import Generator2147
        tests = Generator2147.generate()

    if int(challenge_id) == 2110:
        from source import Generator2110
        tests = Generator2110.generate()

    if int(challenge_id) == 3562:
        from source import Generator3562
        tests = Generator3562.generate()

    if int(challenge_id) == 3573:
        from source import Generator3573
        tests = Generator3573.generate()

    if int(challenge_id) == 3652:
        from source import Generator3652
        tests = Generator3652.generate()

    if int(challenge_id) == 2092:
        from source import Generator2092
        tests = Generator2092.generate()

    if int(challenge_id) == 944:
        from source import Generator944
        tests = Generator944.generate()

    if int(challenge_id) == 955:
        from source import Generator955
        tests = Generator955.generate()

    if int(challenge_id) == 960:
        from source import Generator960
        tests = Generator960.generate()

    if int(challenge_id) == 2054:
        from source import Generator2054
        tests = Generator2054.generate()

    if int(challenge_id) == 3074:
        from source import Generator3074
        tests = Generator3074.generate()

    if int(challenge_id) == 3075:
        from source import Generator3075
        tests = Generator3075.generate()

    if int(challenge_id) == 2483:
        from source import Generator2483
        tests = Generator2483.generate()

    if int(challenge_id) == 2402:
        from source import Generator2402
        tests = Generator2402.generate()

    if int(challenge_id) == 1351:
        from source import Generator1351
        tests = Generator1351.generate()

    if int(challenge_id) == 756:
        from source import Generator756
        tests = Generator756.generate()
    ...
    if int(challenge_id) == 1970:
        from source import Generator1970
        tests = Generator1970.generate()

    if int(challenge_id) == 66:
        from source import Generator66
        tests = Generator66.generate()

    if int(challenge_id) == 961:
        from source import Generator961
        tests = Generator961.generate()

    if int(challenge_id) == 1411:
        from source import Generator1411
        tests = Generator1411.generate()

    if int(challenge_id) == 1390:
        from source import Generator1390
        tests = Generator1390.generate()

    if int(challenge_id) == 1975:
        from source import Generator1975
        tests = Generator1975.generate()

    if int(challenge_id) == 1161:
        from source import Generator1161
        tests = Generator1161.generate()

    if int(challenge_id) == 1339:
        from source import Generator1339
        tests = Generator1339.generate()

    if int(challenge_id) == 1458:
        from source import Generator1458
        tests = Generator1458.generate()

    if int(challenge_id) == 865:
        from source import Generator865
        tests = Generator865.generate()
    ...
    if int(challenge_id) == 3453:
        from source import Generator3453
        tests = Generator3453.generate()

    if int(challenge_id) == 3454:
        from source import Generator3454
        tests = Generator3454.generate()

    if int(challenge_id) == 2943:
        from source import Generator2943
        tests = Generator2943.generate()

    if int(challenge_id) == 2975:
        from source import Generator2975
        tests = Generator2975.generate()

    if int(challenge_id) == 3047:
        from source import Generator3047
        tests = Generator3047.generate()

    if int(challenge_id) == 1895:
        from source import Generator1895
        tests = Generator1895.generate()

    if int(challenge_id) == 1292:
        from source import Generator1292
        tests = Generator1292.generate()

    if int(challenge_id) == 3314:
        from source import Generator3314
        tests = Generator3314.generate()

    if int(challenge_id) == 3315:
        from source import Generator3315
        tests = Generator3315.generate()

    if int(challenge_id) == 3507:
        from source import Generator3507
        tests = Generator3507.generate()

    if int(challenge_id) == 3510:
        from source import Generator3510
        tests = Generator3510.generate()

    if int(challenge_id) == 1877:
        from source import Generator1877
        tests = Generator1877.generate()

    if int(challenge_id) == 1984:
        from source import Generator1984
        tests = Generator1984.generate()

    if int(challenge_id) == 1200:
        from source import Generator1200
        tests = Generator1200.generate()

    if int(challenge_id) == 3650:
        from source import Generator3650
        tests = Generator3650.generate()

    if int(challenge_id) == 3651:
        from source import Generator3651
        tests = Generator3651.generate()

    if int(challenge_id) == 2976:
        from source import Generator2976
        tests = Generator2976.generate()

    if int(challenge_id) == 2977:
        from source import Generator2977
        tests = Generator2977.generate()

    if int(challenge_id) == 744:
        from source import Generator744
        tests = Generator744.generate()

    if int(challenge_id) == 3010:
        from source import Generator3010
        tests = Generator3010.generate()

    if int(challenge_id) == 3013:
        from source import Generator3013
        tests = Generator3013.generate()

    if int(challenge_id) == 3637:
        from source import Generator3637
        tests = Generator3637.generate()

    if int(challenge_id) == 3640:
        from source import Generator3640
        tests = Generator3640.generate()

    if int(challenge_id) == 3379:
        from source import Generator3379
        tests = Generator3379.generate()

    if int(challenge_id) == 3634:
        from source import Generator3634
        tests = Generator3634.generate()

    if int(challenge_id) == 1653:
        from source import Generator1653
        tests = Generator1653.generate()

    if int(challenge_id) == 110:
        from source import Generator110
        tests = Generator110.generate()

    if int(challenge_id) == 1382:
        from source import Generator1382
        tests = Generator1382.generate()

    if int(challenge_id) == 3719:
        from source import Generator3719
        tests = Generator3719.generate()

    if int(challenge_id) == 3721:
        from source import Generator3721
        tests = Generator3721.generate()

    if int(challenge_id) == 3713:
        from source import Generator3713
        tests = Generator3713.generate()

    if int(challenge_id) == 3714:
        from source import Generator3714
        tests = Generator3714.generate()

    if int(challenge_id) == 799:
        from source import Generator799
        tests = Generator799.generate()

    if int(challenge_id) == 67:
        from source import Generator67
        tests = Generator67.generate()

    if int(challenge_id) == 190:
        from source import Generator190
        tests = Generator190.generate()

    if int(challenge_id) == 401:
        from source import Generator401
        tests = Generator401.generate()

    if int(challenge_id) == 693:
        from source import Generator693
        tests = Generator693.generate()

    if int(challenge_id) == 696:
        from source import Generator696
        tests = Generator696.generate()

    if int(challenge_id) == 761:
        from source import Generator761
        tests = Generator761.generate()

    if int(challenge_id) == 762:
        from source import Generator762
        tests = Generator762.generate()

    if int(challenge_id) == 868:
        from source import Generator868
        tests = Generator868.generate()

    if int(challenge_id) == 1461:
        from source import Generator1461
        tests = Generator1461.generate()

    if int(challenge_id) == 1022:
        from source import Generator1022
        tests = Generator1022.generate()
    ...
    if int(challenge_id) == 3666:
        from source import Generator3666
        tests = Generator3666.generate()

    if int(challenge_id) == 1680:
        from source import Generator1680
        tests = Generator1680.generate()

    if int(challenge_id) == 1689:
        from source import Generator1689
        tests = Generator1689.generate()

    if int(challenge_id) == 1536:
        from source import Generator1536
        tests = Generator1536.generate()
    ...
    if int(challenge_id) == 1784:
        from source import Generator1784
        tests = Generator1784.generate()

    if int(challenge_id) == 1888:
        from source import Generator1888
        tests = Generator1888.generate()

    if int(challenge_id) == 1980:
        from source import Generator1980
        tests = Generator1980.generate()

    if int(challenge_id) == 3129:
        from source import Generator3129
        tests = Generator3129.generate()

    if int(challenge_id) == 3130:
        from source import Generator3130
        tests = Generator3130.generate()

    if int(challenge_id) == 1009:
        from source import Generator1009
        tests = Generator1009.generate()

    if int(challenge_id) == 3600:
        from source import Generator3600
        tests = Generator3600.generate()

    if int(challenge_id) == 3296:
        from source import Generator3296
        tests = Generator3296.generate()

    if int(challenge_id) == 1415:
        from source import Generator1415
        tests = Generator1415.generate()

    if int(challenge_id) == 1622:
        from source import Generator1622
        tests = Generator1622.generate()

    if int(challenge_id) == 1878:
        from source import Generator1878
        tests = Generator1878.generate()

    if int(challenge_id) == 1727:
        from source import Generator1727
        tests = Generator1727.generate()

    if int(challenge_id) == 3070:
        from source import Generator3070
        tests = Generator3070.generate()

    if int(challenge_id) == 3212:
        from source import Generator3212
        tests = Generator3212.generate()

    if int(challenge_id) == 3567:
        from source import Generator3567
        tests = Generator3567.generate()

    if int(challenge_id) == 3643:
        from source import Generator3643
        tests = Generator3643.generate()

    if int(challenge_id) == 1886:
        from source import Generator1886
        tests = Generator1886.generate()

    if int(challenge_id) == 1594:
        from source import Generator1594
        tests = Generator1594.generate()

    if int(challenge_id) == 2906:
        from source import Generator2906
        tests = Generator2906.generate()

    if int(challenge_id) == 3546:
        from source import Generator3546
        tests = Generator3546.generate()

    if int(challenge_id) == 3548:
        from source import Generator3548
        tests = Generator3548.generate()

    if int(challenge_id) == 2946:
        from source import Generator2946
        tests = Generator2946.generate()

    if int(challenge_id) == 2573:
        from source import Generator2573
        tests = Generator2573.generate()

    if int(challenge_id) == 2839:
        from source import Generator2839
        tests = Generator2839.generate()

    if int(challenge_id) == 2840:
        from source import Generator2840
        tests = Generator2840.generate()

    if int(challenge_id) == 3474:
        from source import Generator3474
        tests = Generator3474.generate()

    if int(challenge_id) == 2751:
        from source import Generator2751
        tests = Generator2751.generate()

    if int(challenge_id) == 3418:
        from source import Generator3418
        tests = Generator3418.generate()

    if int(challenge_id) == 3661:
        from source import Generator3661
        tests = Generator3661.generate()

    if int(challenge_id) == 2075:
        from source import Generator2075
        tests = Generator2075.generate()

    if int(challenge_id) == 657:
        from source import Generator657
        tests = Generator657.generate()

    if int(challenge_id) == 874:
        from source import Generator874
        tests = Generator874.generate()

    if int(challenge_id) == 2069:
        from source import Generator2069
        tests = Generator2069.generate()

    if int(challenge_id) == 3653:
        from source import Generator3653
        tests = Generator3653.generate()

    if int(challenge_id) == 3655:
        from source import Generator3655
        tests = Generator3655.generate()

    if int(challenge_id) == 3740:
        from source import Generator3740
        tests = Generator3740.generate()

    if int(challenge_id) == 3741:
        from source import Generator3741
        tests = Generator3741.generate()

    if int(challenge_id) == 1320:
        from source import Generator1320
        tests = Generator1320.generate()

    if int(challenge_id) == 1848:
        from source import Generator1848
        tests = Generator1848.generate()

    if int(challenge_id) == 2463:
        from source import Generator2463
        tests = Generator2463.generate()

    if int(challenge_id) == 2515:
        from source import Generator2515
        tests = Generator2515.generate()

    if int(challenge_id) == 3488:
        from source import Generator3488
        tests = Generator3488.generate()

    if int(challenge_id) == 3761:
        from source import Generator3761
        tests = Generator3761.generate()

    if int(challenge_id) == 3783:
        from source import Generator3783
        tests = Generator3783.generate()

    if int(challenge_id) == 1855:
        from source import Generator1855
        tests = Generator1855.generate()

    if int(challenge_id) == 2078:
        from source import Generator2078
        tests = Generator2078.generate()

    if int(challenge_id) == 1722:
        from source import Generator1722
        tests = Generator1722.generate()

    if int(challenge_id) == 2452:
        from source import Generator2452
        tests = Generator2452.generate()

    if int(challenge_id) == 2615:
        from source import Generator2615
        tests = Generator2615.generate()

    if int(challenge_id) == 2833:
        from source import Generator2833
        tests = Generator2833.generate()

    if int(challenge_id) == 3464:
        from source import Generator3464
        tests = Generator3464.generate()

    if int(challenge_id) == 1559:
        from source import Generator1559
        tests = Generator1559.generate()

    if int(challenge_id) == 1391:
        from source import Generator1391
        tests = Generator1391.generate()

    if int(challenge_id) == 2033:
        from source import Generator2033
        tests = Generator2033.generate()

    if int(challenge_id) == 3225:
        from source import Generator3225
        tests = Generator3225.generate()

    if int(challenge_id) == 3742:
        from source import Generator3742
        tests = Generator3742.generate()

    if int(challenge_id) == 396:
        from source import Generator396
        tests = Generator396.generate()

    if int(challenge_id) == 788:
        from source import Generator788
        tests = Generator788.generate()

    if int(challenge_id) == 796:
        from source import Generator796
        tests = Generator796.generate()

    if int(challenge_id) == 48:
        from source import Generator48
        tests = Generator48.generate()

    if int(challenge_id) == 61:
        from source import Generator61
        tests = Generator61.generate()

    if int(challenge_id) == 1861:
        from source import Generator1861
        tests = Generator1861.generate()

    if int(challenge_id) == 3660:
        from source import Generator3660
        tests = Generator3660.generate()

    if int(challenge_id) == 3629:
        from source import Generator3629
        tests = Generator3629.generate()

    if int(challenge_id) == 1914:
        from source import Generator1914
        tests = Generator1914.generate()

    if int(challenge_id) == 2770:
        from source import Generator2770
        tests = Generator2770.generate()

    if int(challenge_id) == 2553:
        from source import Generator2553
        tests = Generator2553.generate()

    if int(challenge_id) == 1665:
        from source import Generator1665
        tests = Generator1665.generate()

    if int(challenge_id) == 1674:
        from source import Generator1674
        tests = Generator1674.generate()

    if int(challenge_id) == 2784:
        from source import Generator2784
        tests = Generator2784.generate()

    if int(challenge_id) == 153:
        from source import Generator153
        tests = Generator153.generate()

    if int(challenge_id) == 154:
        from source import Generator154
        tests = Generator154.generate()

    if int(challenge_id) == 1306:
        from source import Generator1306
        tests = Generator1306.generate()

    if int(challenge_id) == 1345:
        from source import Generator1345
        tests = Generator1345.generate()
    ...
    if int(challenge_id) == 1340:
        from source import Generator1340
        tests = Generator1340.generate()

    if int(challenge_id) == 1871:
        from source import Generator1871
        tests = Generator1871.generate()

    if int(challenge_id) == 3120:
        from source import Generator3120
        tests = Generator3120.generate()

    if int(challenge_id) == 3121:
        from source import Generator3121
        tests = Generator3121.generate()

    if int(challenge_id) == 3093:
        from source import Generator3093
        tests = Generator3093.generate()

    if int(challenge_id) == 3300:
        from source import Generator3300
        tests = Generator3300.generate()

    if int(challenge_id) == 3161:
        from source import Generator3161
        tests = Generator3161.generate()

    if int(challenge_id) == 2126:
        from source import Generator2126
        tests = Generator2126.generate()

    if int(challenge_id) == 2144:
        from source import Generator2144
        tests = Generator2144.generate()

    if int(challenge_id) == 3633:
        from source import Generator3633
        tests = Generator3633.generate()

    if int(challenge_id) == 3635:
        from source import Generator3635
        tests = Generator3635.generate()

    if int(challenge_id) == 3751:
        from source import Generator3751
        tests = Generator3751.generate()

    if int(challenge_id) == 3753:
        from source import Generator3753
        tests = Generator3753.generate()

    if int(challenge_id) == 2574:
        from source import Generator2574
        tests = Generator2574.generate()
    ...
    if int(challenge_id) == 3689:
        from source import Generator3689
        tests = Generator3689.generate()

    if int(challenge_id) == 3691:
        from source import Generator3691
        tests = Generator3691.generate()

    if int(challenge_id) == 3558:
        from source import Generator3558
        tests = Generator3558.generate()

    if int(challenge_id) == 3559:
        from source import Generator3559
        tests = Generator3559.generate()

    if int(challenge_id) == 3838:
        from source import Generator3838
        tests = Generator3838.generate()

    if int(challenge_id) == 2130:
        from source import Generator2130
        tests = Generator2130.generate()

    if int(challenge_id) == 2095:
        from source import Generator2095
        tests = Generator2095.generate()

    if int(challenge_id) == 3612:
        from source import Generator3612
        tests = Generator3612.generate()

    if int(challenge_id) == 3614:
        from source import Generator3614
        tests = Generator3614.generate()

    if int(challenge_id) == 1344:
        from source import Generator1344
        tests = Generator1344.generate()

    if int(challenge_id) == 1732:
        from source import Generator1732
        tests = Generator1732.generate()

    if int(challenge_id) == 1840:
        from source import Generator1840
        tests = Generator1840.generate()

    if int(challenge_id) == 1833:
        from source import Generator1833
        tests = Generator1833.generate()

    if int(challenge_id) == 1189:
        from source import Generator1189
        tests = Generator1189.generate()

    if int(challenge_id) == 3699:
        from source import Generator3699
        tests = Generator3699.generate()

    if int(challenge_id) == 3700:
        from source import Generator3700
        tests = Generator3700.generate()

    if int(challenge_id) == 3737:
        from source import Generator3737
        tests = Generator3737.generate()

    if int(challenge_id) == 3739:
        from source import Generator3739
        tests = Generator3739.generate()

    if int(challenge_id) == 3020:
        from source import Generator3020
        tests = Generator3020.generate()

    if int(challenge_id) == 1846:
        from source import Generator1846
        tests = Generator1846.generate()

    if int(challenge_id) == 1967:
        from source import Generator1967
        tests = Generator1967.generate()
    ...
    if int(challenge_id) == 3286:
        from source import Generator3286
        tests = Generator3286.generate()

    if int(challenge_id) == 3620:
        from source import Generator3620
        tests = Generator3620.generate()

    if int(challenge_id) == 2492:
        from source import Generator2492
        tests = Generator2492.generate()

    if int(challenge_id) == 1301:
        from source import Generator1301
        tests = Generator1301.generate()

    if int(challenge_id) == 1288:
        from source import Generator1288
        tests = Generator1288.generate()

    if int(challenge_id) == 3754:
        from source import Generator3754
        tests = Generator3754.generate()

    if int(challenge_id) == 3756:
        from source import Generator3756
        tests = Generator3756.generate()

    if int(challenge_id) == 3532:
        from source import Generator3532
        tests = Generator3532.generate()

    if int(challenge_id) == 3534:
        from source import Generator3534
        tests = Generator3534.generate()
    ...
    if int(challenge_id) == 3336:
        from source import Generator3336
        tests = Generator3336.generate()

    if int(challenge_id) == 3658:
        from source import Generator3658
        tests = Generator3658.generate()

    if int(challenge_id) == 3867:
        from source import Generator3867
        tests = Generator3867.generate()

    if int(challenge_id) == 3312:
        from source import Generator3312
        tests = Generator3312.generate()

    if int(challenge_id) == 1979:
        from source import Generator1979
        tests = Generator1979.generate()

    if int(challenge_id) == 1081:
        from source import Generator1081
        tests = Generator1081.generate()

    if int(challenge_id) == 1260:
        from source import Generator1260
        tests = Generator1260.generate()

    if int(challenge_id) == 3499:
        from source import Generator3499
        tests = Generator3499.generate()

    if int(challenge_id) == 3501:
        from source import Generator3501
        tests = Generator3501.generate()

    if int(challenge_id) == 3513:
        from source import Generator3513
        tests = Generator3513.generate()

    if int(challenge_id) == 3514:
        from source import Generator3514
        tests = Generator3514.generate()

    if int(challenge_id) == 3536:
        from source import Generator3536
        tests = Generator3536.generate()

    if int(challenge_id) == 628:
        from source import Generator628
        tests = Generator628.generate()

    if int(challenge_id) == 1464:
        from source import Generator1464
        tests = Generator1464.generate()

    if int(challenge_id) == 3517:
        from source import Generator3517
        tests = Generator3517.generate()

    if int(challenge_id) == 3518:
        from source import Generator3518
        tests = Generator3518.generate()

    if int(challenge_id) == 3014:
        from source import Generator3014
        tests = Generator3014.generate()

    if int(challenge_id) == 3016:
        from source import Generator3016
        tests = Generator3016.generate()

    if int(challenge_id) == 486:
        from source import Generator486
        tests = Generator486.generate()

    if int(challenge_id) == 877:
        from source import Generator877
        tests = Generator877.generate()

    if int(challenge_id) == 1406:
        from source import Generator1406
        tests = Generator1406.generate()

    if int(challenge_id) == 3731:
        from source import Generator3731
        tests = Generator3731.generate()

    if int(challenge_id) == 3310:
        from source import Generator3310
        tests = Generator3310.generate()

    if int(challenge_id) == 3345:
        from source import Generator3345
        tests = Generator3345.generate()

    if int(challenge_id) == 3348:
        from source import Generator3348
        tests = Generator3348.generate()

    if int(challenge_id) == 3302:
        from source import Generator3302
        tests = Generator3302.generate()

    if int(challenge_id) == 1140:
        from source import Generator1140
        tests = Generator1140.generate()

    if int(challenge_id) == 1510:
        from source import Generator1510
        tests = Generator1510.generate()

    if int(challenge_id) == 2996:
        from source import Generator2996
        tests = Generator2996.generate()

    if int(challenge_id) == 2958:
        from source import Generator2958
        tests = Generator2958.generate()

    if int(challenge_id) == 2213:
        from source import Generator2213
        tests = Generator2213.generate()

    if int(challenge_id) == 3090:
        from source import Generator3090
        tests = Generator3090.generate()

    if int(challenge_id) == 3702:
        from source import Generator3702
        tests = Generator3702.generate()

    if int(challenge_id) == 2029:
        from source import Generator2029
        tests = Generator2029.generate()

    if int(challenge_id) == 1563:
        from source import Generator1563
        tests = Generator1563.generate()

    if int(challenge_id) == 3471:
        from source import Generator3471
        tests = Generator3471.generate()

    if int(challenge_id) == 1386:
        from source import Generator1386
        tests = Generator1386.generate()

    if int(challenge_id) == 3069:
        from source import Generator3069
        tests = Generator3069.generate()

    if int(challenge_id) == 3116:
        from source import Generator3116
        tests = Generator3116.generate()

    if int(challenge_id) == 3622:
        from source import Generator3622
        tests = Generator3622.generate()

    if int(challenge_id) == 1927:
        from source import Generator1927
        tests = Generator1927.generate()

    if int(challenge_id) == 1872:
        from source import Generator1872
        tests = Generator1872.generate()

    if int(challenge_id) == 3718:
        from source import Generator3718
        tests = Generator3718.generate()

    if int(challenge_id) == 2904:
        from source import Generator2904
        tests = Generator2904.generate()

    if int(challenge_id) == 3720:
        from source import Generator3720
        tests = Generator3720.generate()

    if int(challenge_id) == 3734:
        from source import Generator3734
        tests = Generator3734.generate()

    if int(challenge_id) == 2948:
        from source import Generator2948
        tests = Generator2948.generate()

    if int(challenge_id) == 2091:
        from source import Generator2091
        tests = Generator2091.generate()

    if int(challenge_id) == 2058:
        from source import Generator2058
        tests = Generator2058.generate()

    if int(challenge_id) == 3568:
        from source import Generator3568
        tests = Generator3568.generate()

    if int(challenge_id) == 3875:
        from source import Generator3875
        tests = Generator3875.generate()

    if int(challenge_id) == 3876:
        from source import Generator3876
        tests = Generator3876.generate()

    if int(challenge_id) == 3903:
        from source import Generator3903
        tests = Generator3903.generate()

    if int(challenge_id) == 3904:
        from source import Generator3904
        tests = Generator3904.generate()

    if int(challenge_id) == 115:
        from source import Generator115
        tests = Generator115.generate()

    if int(challenge_id) == 940:
        from source import Generator940
        tests = Generator940.generate()

    if int(challenge_id) == 3870:
        from source import Generator3870
        tests = Generator3870.generate()

    if int(challenge_id) == 3871:
        from source import Generator3871
        tests = Generator3871.generate()

    if int(challenge_id) == 2265:
        from source import Generator2265
        tests = Generator2265.generate()

    if int(challenge_id) == 3483:
        from source import Generator3483
        tests = Generator3483.generate()

    if int(challenge_id) == 3414:
        from source import Generator3414
        tests = Generator3414.generate()

    if int(challenge_id) == 835:
        from source import Generator835
        tests = Generator835.generate()

    if int(challenge_id) == 836:
        from source import Generator836
        tests = Generator836.generate()

    if int(challenge_id) == 2472:
        from source import Generator2472
        tests = Generator2472.generate()

    if int(challenge_id) == 1621:
        from source import Generator1621
        tests = Generator1621.generate()

    if int(challenge_id) == 1477:
        from source import Generator1477
        tests = Generator1477.generate()

    if int(challenge_id) == 1520:
        from source import Generator1520
        tests = Generator1520.generate()

    if int(challenge_id) == 1401:
        from source import Generator1401
        tests = Generator1401.generate()

    if int(challenge_id) == 3498:
        from source import Generator3498
        tests = Generator3498.generate()

    if int(challenge_id) == 3524:
        from source import Generator3524
        tests = Generator3524.generate()

    if int(challenge_id) == 3525:
        from source import Generator3525
        tests = Generator3525.generate()

    if int(challenge_id) == 1658:
        from source import Generator1658
        tests = Generator1658.generate()

    if int(challenge_id) == 3550:
        from source import Generator3550
        tests = Generator3550.generate()

    if int(challenge_id) == 1096:
        from source import Generator1096
        tests = Generator1096.generate()
